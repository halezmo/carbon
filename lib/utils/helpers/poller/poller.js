...
exports.default = function (queryOptions, functions, options) {
  ...
  var queryOpts = getQueryOptions(queryOptions);
  var funcs = getFunctions(functions);
  ...
  return new Promise(function (resolve, reject) {
    ...
    (function poll() {
      ...
      _superagent2.default.get(queryOpts.url).query(queryOpts.data).set(queryOpts.headers).end(function (err, response) {
        var result = void 0;
...
function setupValid(queryOptions, functions) {
  ...
  if (typeof functions.conditionMet !== 'undefined' && typeof functions.callback === 'undefined') {
    var msg = 'You must provide a callback function if you are testing a condition with conditionMet';
