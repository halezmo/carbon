...
var InputValidation = function InputValidation(ComposedComponent) {
    ...
    function Component() {
      ...
      _this.positionMessage = function () {
        if (!_this.state.valid || _this.state.warning || _this.state.info) {
          ...
          var icon = _this.validationIcon._target,
          ...
          if (icon && message && message.offsetHeight) {
            ...
            var topOffset = icon.offsetTop - icon.offsetHeight;
      ...
      _this._handleContentChange = function () {
        ...
        if (!_this.state.valid || _this.state.warning || _this.state.info) {
          ...
          _this.setState({ errorMessage: null, valid: true, warning: false, info: false });
        }
      };
  ...
  }), _class.propTypes = (0, _lodash.assign)({}, ComposedComponent.propTypes, {
