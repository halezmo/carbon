...
var Dialog = function (_Modal) {
  ...
  _createClass(Dialog, [{
    ...
    get: function get() {
      ...
      _elementResize2.default.removeListener(this._innerContent, this.applyFixedBottom);
    }
    ...
    get: function get() {
      ...
      return (0, _classnames2.default)('carbon-dialog__dialog', (_classNames = {}, _defineProperty(_classNames, 'carbon-dialog__dialog--' + this.props.size, typeof this.props.size !== 'undefined'), _defineProperty(_classNames, 'carbon-dialog__dialog--fixed-bottom', this.appliedFixedBottom), _defineProperty(_classNames, 'carbon-dialog__dialog--has-height', this.props.height), _classNames));
    }
  }, {
    key: 'closeIcon',
    get: function get() {
