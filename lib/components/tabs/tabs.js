...
var Tabs = _wrapComponent('Tabs')((_temp2 = _class = function (_React$Component) {
  ...
  function Tabs() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
       ...
       */
    }, _this._window = window, _this.changeValidity = function (id, valid) {
  ...
  _createClass(Tabs, [{
    ...
    */
    ...
    get: function get() {
      ...
      (0, _lodash.compact)(_react3.default.Children.toArray(this.props.children)).forEach(function (child) {
