  ...
  _createClass(Pod, [{
    ...
    value: function render() {
      ...
      return _react3.default.createElement(
        'div',
        _extends({ className: this.mainClasses }, props, (0, _tags2.default)('pod', this.props)),
    ...
    get: function get() {
      ...
      return _react3.default.createElement(
        ...
        _react3.default.createElement(
          _link2.default,
          _extends({ icon: 'edit', className: this.editActionClasses }, this.linkProps()),
          _i18nJs2.default.t('actions.edit', { defaultValue: 'Edit' })
        )
      );
    }
