...
var _definition3 = require('./../form/definition');
...
var definition = new _definition2.default('show-edit-pod', _2.default, {
  ...
  propOptions: (0, _lodash.assign)({}, _definition4.default.propOptions, {
    as: _optionsHelper2.default.themesFull
  }),
  defaultProps: (0, _lodash.assign)({}, _definition4.default.defaultProps, _2.default.defaultProps),
  propTypes: (0, _lodash.assign)({}, _definition4.default.propTypes, {
    children: "Node",
    className: "String",
    editing: "Boolean",
    onEdit: "Function",
  ...
  propDescriptions: (0, _lodash.assign)({}, _definition4.default.propDescriptions, {
