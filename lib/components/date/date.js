...
var Date = (0, _input2.default)((0, _inputIcon2.default)((0, _inputLabel2.default)((0, _inputValidation2.default)(_wrapComponent('Date')((_temp2 = _class = function (_React$Component) {
  ...
  _createClass(Date, [{
    ...
    value: function render() {
      ...
      return _react3.default.createElement(
        'div',
        _extends({ className: this.mainClasses, onClick: this.handleWidgetClick }, (0, _tags2.default)('date', this.props)),
        this.labelHTML,
        this.inputHTML,
        _react3.default.createElement('input', _extends({}, this.hiddenInputProps, { ref: function ref(node) {
            _this2.hidden = node;
          } })),
        datePicker,
        this.fieldHelpHTML
