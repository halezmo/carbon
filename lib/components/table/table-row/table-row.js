...
var TableRow = _wrapComponent('TableRow')((_temp2 = _class = function (_React$Component) {
  ...
  _createClass(TableRow, [{
    ...
    value: function render() {
      ...
      return this.renderDraggableRow(_react3.default.createElement(
        'tr',
  ...
  this.draggingIsOccurring = function () {
    return typeof _this2.context.dragAndDropActiveIndex === 'number';
  };

  this.renderDraggableCell = function () {
    if (!_this2.context.dragDropManager) {
      return null;
    }

    return _react3.default.createElement(_draggableTableCell2.default, { identifier: _this2.props.dragAndDropIdentifier });
  };
  ...
  this.renderDraggableRow = function (row) {
    ...
    return _react3.default.createElement(
      _withDrop2.default,
      {
        identifier: _this2.props.dragAndDropIdentifier,
