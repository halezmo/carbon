 ...
 */
var Checkbox = (0, _input2.default)((0, _inputLabel2.default)((0, _inputValidation2.default)(_wrapComponent('Checkbox')((_temp2 = _class = function (_React$Component) {
  ...
  _createClass(Checkbox, [{
    ...
    get: function get() {
      return _react3.default.createElement(
        ...
        _react3.default.createElement('rect', { className: 'checkbox-outline', fill: '#AFAFAF', x: '0', y: '0', width: '15', height: '15' }),
        _react3.default.createElement('rect', { className: 'checkbox-fill', fill: '#FFFFFF', x: '1', y: '1', width: '13', height: '13' }),
